...
const CORE_ERROR_DEFINITIONS = Object.freeze([
	{
		...
		recovery: [
			"Review the error metadata and retry if the operation is safe to repeat.",
		],
	},
	{
	...
	},
	{
		...
		recovery: [
			"Grant the required permission or run the command in an authorized context.",
		],
	},
	{
	...
	},
	{
		...
		recovery: [
			"Review layer metadata and continue with graceful degradation when possible.",
		],
	},
	{
		...
		recovery: [
			"Review execution logs and retry after correcting the failure cause.",
		],
	},
	{
		...
		recovery: [
			"Review external executor logs and retry if the command is idempotent.",
		],
	},
	{
