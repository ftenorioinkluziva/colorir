...
const TEST_QUERIES = [
	...
	{
		query: "scrape social media data",
		expectedTool: "apify",
		category: "web-scraping",
	},
	{
		query: "analyze code dependencies",
		expectedTool: "code-graph",
		category: "code-intelligence",
	},
	{
		query: "code analysis intelligence",
		expectedTool: "nogic",
		category: "code-intelligence",
	},
	{
		query: "look up library documentation",
...
function validate() {
	...
	console.log(
		`  Essential (never disable): ${essential.map(([n]) => n).join(", ")}`,
	);
	console.log(
		`  Non-essential (can disable): ${nonEssential.map(([n]) => n).join(", ")}`,
	);
	...
	console.log(
		"Implementation: CLAUDE.md guidance section (not programmatic hard limit)",
	);
	console.log(
