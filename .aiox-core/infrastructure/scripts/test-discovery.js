...
class TestRunner extends EventEmitter {
	...
	parseOutput(output) {
		...
		if (jestMatch) {
			summary.passed = Number.parseInt(jestMatch[1]) || 0;
			summary.failed = Number.parseInt(jestMatch[2]) || 0;
			summary.skipped = Number.parseInt(jestMatch[3]) || 0;
			summary.total =
				Number.parseInt(jestMatch[4]) ||
		...
		if (mochaMatch) {
			summary.passed = Number.parseInt(mochaMatch[1]) || 0;
			summary.failed = Number.parseInt(mochaMatch[2]) || 0;
		...
		if (pytestMatch) {
			summary.passed = Number.parseInt(pytestMatch[1]) || 0;
			summary.failed = Number.parseInt(pytestMatch[2]) || 0;
			summary.skipped = Number.parseInt(pytestMatch[3]) || 0;
