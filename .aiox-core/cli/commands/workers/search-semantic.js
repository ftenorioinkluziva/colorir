...
const OPENAI_REQUEST_TIMEOUT_MS =
	Number.parseInt(process.env.OPENAI_REQUEST_TIMEOUT_MS) || 10000; // 10s default
const RATE_LIMIT_DELAY_MS =
	Number.parseInt(process.env.RATE_LIMIT_DELAY_MS) || 600; // 600ms for 100 RPM (Free tier)
